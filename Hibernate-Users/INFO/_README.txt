...
Техстек: Maven, MySQL, Hibernate (HQL).

------------------

HQL (Hibernate Query Language) – об'єктно-орієнтована мова
запитів, яка дуже схожа на SQL.
https://docs.jboss.org/hibernate/orm/6.4/userguide/html_single/Hibernate_User_Guide.html#hql
https://docs.jboss.org/hibernate/orm/6.4/userguide/html_single/Hibernate_User_Guide.html#query-language
...
2) Складаємо SQL-запити (див. SQLs.sql).
